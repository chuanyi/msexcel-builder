...
(function() {
  var Anchor, CalcChain, ContentTypes, DocPropsApp, Image, ImageType, JSDateToExcel, JSZip, SharedStrings, Sheet, Style, Workbook, WorksheetComments, WorksheetCommentsDrawings, XlDrawingRels, XlWorkbook, XlWorkbookRels, XlWorksheetRels, addressRegex, baseXl, colCache, fs, tool, xml,
  ...
  WorksheetComments = (function() {
    ...
    WorksheetComments.prototype.toxml = function() {
      var cellRef, col, comment, commentList, entry, note, ref, row, rs, run, text;
  ...
  WorksheetCommentsDrawings = (function() {
    ...
    WorksheetCommentsDrawings.prototype.toxml = function() {
      var cd, cellRef, col, entry, note, ref, row, rs, shape;
      rs = xml.create('xml');
