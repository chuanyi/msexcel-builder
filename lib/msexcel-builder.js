...
(function() {
  var ContentTypes, DocPropsApp, JSDateToExcel, JSZip, SharedStrings, Sheet, Style, Workbook, XlRels, XlWorkbook, baseXl, fs, tool, xml,
  ...
  Sheet = (function() {
    ...
    Sheet.prototype.toxml = function() {
      var c, cb, cols, cw, ht, i, ix, j, l, len, len1, len2, len3, m, mc, n, p, q, r, ref, ref1, ref2, ref3, ref4, ref5, sd, sid, t, u, ws;
  ...
  Style = (function() {
    ...
    Style.prototype.font2id = function(font) {
      ...
      font || (font = {});
      font.bold || (font.bold = '-');
      font.iter || font.italic || (font.iter = '-');
      ...
      k = 'font_' + font.bold + font.iter + font.underline + font.strike + font.outline + font.shadow + font.sz + font.color + font.name + font.scheme + font.family;
      id = this.cache[k];
      if (id) {
        return id;
      } else {
