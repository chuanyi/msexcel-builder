...
(function() {
  ...
  Image = (function() {
    function Image(worksheet, model1) {
      this.worksheet = worksheet;
      this.model = model1;
    }
          ...
          set: function(model) {
            ...
            if (model.type === 'image') {
              if (typeof model.range === 'string') {
                ...
                return this.range = {
                  tl: new Anchor(this.worksheet, model.range.tl, 0),
                  br: model.range.br && new Anchor(this.worksheet, model.range.br, 0),
                  ext: model.range.ext,
  ...
  Sheet = (function() {
    ...
    Sheet.prototype.addImage = function(image) {
      ...
      imageToAdd = new Image(id, image.extension, image.base64, this.range);
  ...
  Image = (function() {
    function Image(id1, extension, content, range1) {
      this.id = id1;
    ...
    Image.prototype.toDrawingXml = function(svgVersionRel) {
      var _from, _to, blip, blipFill, blipModel, cNvPr, dr, ext, extLst, graphic_index, nvPicPr, pic, pngVersionRel, spPr, twoCellAnchor, xfrm;
      pngVersionRel = 'rId1';
